...
const News = () => {
  ...
  useEffect(() => {
    setNews(fetchNews(category));

    // setNews([
    //   {
    //     "article_id": "8b4a8090ecb5eb152715dfa0e7fc620f",
    //     "title": "IPL 2024: लीग स्टेज में कोलकाता बनी जीत की बादशाह, मुंबई ने गंवाए सबसे ज़्यादा मैच; जानें सभी टीमों का हाल",
    ...
    //     "title": "Kaiserganj Loksabha Seat: कैसरगंज में वोटिंग शुरू, बीजेपी के करणभूषण और सपा से भगतराम के बीच मुकाबला",
    ...
    //     ],
    //     "video_url": null,
    //     "description": "Kaiserganj Loksabha Seat Voting: कैसरगंज लोकसभा सीट पर 20 मई यानी आज सुबह 7 बजे से मतदान शुरू हो चुका है. बीजेपी से करण भूषण सिंह, समाजवादी पार्टी से भगत राम यादव और बसपा से नरेंद्र पांडेय चुनाव लड़ रहे हैं.",
    //     "content": "ONLY AVAILABLE IN PAID PLANS",
    //     "pubDate": "2024-05-20 02:07:32",
    //     "image_url": "https://hindi.cdn.zeenews.com/hindi/sites/default/files/2024/05/20/2879387-kaiserganj-loksabha-1.png?im=FitAndFill=(1200,900)",
    //     "source_id": "zeenews",
    ...
    //     "title": "छत्तीसगढ़ में बादल छाए रहने के कारण तापमान कम, उमस से बढ़ी बेचैनी",
    ...
    //     ],
    //     "video_url": null,
    //     "description": "Chhattisgarh Weather Update: मौसम विभाग का कहना है कि आज सोमवार को भी सुबह से आसमान पर बादल छाए रहेंगे और शाम या रात को गरज-चमक के साथ हल्की बारिश हो सकती है.",
    //     "content": "ONLY AVAILABLE IN PAID PLANS",
    //     "pubDate": "2024-05-20 02:07:25",
    //     "image_url": "https://images.news18.com/ibnkhabar/uploads/2024/05/HYP_4444527_Ra_Ku_3427_Rai_1-3x2.jpg",
    ...
    //     "title": "'हेलो मैं SP चारू बोल रही हूं' महिला कांस्टेबल को आया फोन, घबराते हुए बोली...",
    ...
    //     ],
    //     "video_url": null,
    //     "description": "Auraiya Latest News: यूपी के औरैया में दिबियापुर थाने में तैनात महिला कॉन्स्टेबल के पास एक कॉल आई. दूसरी तरफ से आवाज आई कि मैं एसपी चारू निगम बात कर रही हूं. आप कई दिनों ने ड्यूटी पर नहीं आ रही हैं. यह सब कहकर महिला कॉन्स्टेबल को सस्पेंड करने की धमकी तक दे डाली. इसके बाद जो हुआ... आइए विस्तार से जानते हैं पूरा मामला...",
    //     "content": "ONLY AVAILABLE IN PAID PLANS",
    //     "pubDate": "2024-05-20 02:07:24",
    //     "image_url": "https://images.news18.com/ibnkhabar/uploads/2024/05/lady-police-2024-05-11f4d9fb206222357d58a99b770f7dd9-3x2.jpg",
    //     "source_id": "hindinews18",
    //     "source_priority": 6509,
    //     "source_url": "https://hindi.news18.com",
    //     "source_icon": null,
    ...
    //     "title": "रात में दूध में भिगो दें ये एक चीज और सुबह खाली पेट कर लें सेवन, मसल्स बढ़ाने में है मददगार",
    ...
    //     "creator": null,
    //     "video_url": null,
    //     "description": "Muscles Gain Drink: मसल्स को बढ़ाना चाहते हैं तो रात में दूध में 3-4 खजूर को भिगोकर रख दें. फिर अगली सुबह इनका सेवन कर लें.",
    //     "content": "ONLY AVAILABLE IN PAID PLANS",
    //     "pubDate": "2024-05-20 02:07:03",
    //     "image_url": "https://c.ndtvimg.com/2023-09/q0r83q8g_milk_625x300_28_September_23.jpg?im=FaceCrop,algorithm=dnn,width=1200,height=738",
    //     "source_id": "ndtv",
    ...
    //     "title": "खाने से पहले मशरुम धूप में रखने से विटामिन D जाता है बढ़? जानिए इस बात में कितनी है सच्चाई",
    ...
    //     "creator": null,
    //     "video_url": null,
    //     "description": "Vitamin d deficiency : मशरूम को लेकर एक बात कही जाती है कि, इसे सूर्य की रोशनी में रखने से विटामिन 'डी' की मात्रा बढ़ जाती है. क्या सच में ऐसा है?",
    //     "content": "ONLY AVAILABLE IN PAID PLANS",
    //     "pubDate": "2024-05-20 02:06:52",
    //     "image_url": "https://c.ndtvimg.com/2023-07/1tojdq7_mushrooms_625x300_12_July_23.jpg?im=FaceCrop,algorithm=dnn,width=1200,height=738",
    //     "source_id": "ndtv",
    //     "source_priority": 1204,
    //     "source_url": "http://www.ndtv.com",
    //     "source_icon": "https://i.bytvi.com/domain_icons/ndtv.png",
    ...
    //     "title": "अगर सुबह उठते ही सपने में दिखे ये 5 चीजें तो बदल सकती है आपकी किस्मत",
    ...
    //     ],
    //     "video_url": null,
    //     "description": "जरूरी नहीं कि सपने हमेशा सच हों, लेकिन कुछ सपने आपके भविष्य का संकेत भी दे सकते हैं। किसी भी सपने का अर्थ उसे देखने के समय पर भी निर्भर करता है। हम अक्सर सपनों को ऐसी घटनाओं के रूप में सोचते हैं जो हमारे लिए बहुत महत्वपूर्ण नहीं हैं और जागते ही हम उनके ...",
    //     "content": "ONLY AVAILABLE IN PAID PLANS",
    //     "pubDate": "2024-05-20 02:06:36",
    //     "image_url": "https://newsindialive.in/wp-content/uploads/2024/05/image-2024-05-19T233624.504.jpg",
    ...
    //     "title": "सुमोना करेंगी ये TV शो, बताया क्यों नहीं किया 'द ग्रेट इंडियन कपिल शो' में काम",
    ...
    //     ],
    //     "video_url": null,
    //     "description": "सुमोना चक्रवर्ती ने कपिल शर्मा के साथ कॉमेडी सर्कस से लेकर द कपिल शर्मा शो तक साथ काम किया. लेकिन वह अब नेटफ्लिक्स पर आ रहे 'द ग्रेट इंडियन कपिल शो' में नहीं हैं. इस पर उन्होंने प्रतिक्रिया दी है.",
    //     "content": "ONLY AVAILABLE IN PAID PLANS",
    //     "pubDate": "2024-05-20 02:06:08",
    //     "image_url": "https://images.news18.com/ibnkhabar/uploads/2024/05/Sumona-Chakravarty-Kapil-sharma-Show-2024-05-4ce6cdf8a6f79d457149cbaf5574e002-3x2.jpg",
    //     "source_id": "hindinews18",
    //     "source_priority": 6509,
    //     "source_url": "https://hindi.news18.com",
    //     "source_icon": null,
    ...
    //     "title": "ईरानी राष्ट्रपति के हेलीकॉप्टर दुर्घटना के बाद भू-राजनीतिक उथल-पुथल, धातु रैली के बीच सोने की कीमतें रिकॉर्ड ऊंचाई पर पहुंच गईं",
  ...
  function fetchNews(categ = null, country = null) {
  ...
  function fetchMoreNews() {
    setNews(...news, fetchNews(category));
  }
